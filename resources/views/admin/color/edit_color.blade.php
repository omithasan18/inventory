...
@section('title')
    <title>{{ config('app.name') }} | Edit Color</title>
@endsection
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-header" style="text-align: right">
                                ...
                                <a href="{{route('color.create')}}" class="btn btn-success"> + Add New </a>
                              </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                                <form action="{{route('color.update',$color_by_id->id)}}" method="post">
                                    @method('patch')
                                    @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Color Name</label>
                                        <input type="text" name="color_name" value="{{$color_by_id->color_name}}" class="form-control" id="exampleInputEmail1" placeholder="Color Name">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <!-- select -->
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" name="status">
                                                    <option value="1" @php if ($color_by_id['status'] == 1) { echo "selected"; } @endphp>Active</option>
                                                    <option value="0" @php if ($color_by_id['status'] == 0) { echo "selected"; } @endphp>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
