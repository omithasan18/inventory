        ...
        <div class="col-12">
          ...
          <div class="invoice p-3 mb-3">
            ...
            <div class="row">
              <div class="col-12">
                <h4>
                  <img src="{{$head_customer->image}}" alt="" height="60px" width="60px"> {{$head_customer->business_name}}
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-6 invoice-col">
                To
                <address>
                  <strong>{{$head_customer->name}}</strong><br>
                  Address: {{$head_customer->address}}<br>
                  Phone:  {{$head_customer->phone}}<br>
                  Email:  {{$head_customer->email}}
                </address>
              </div>
              <!-- /.col -->
              <div class="col-sm-6 invoice-col">
              <b>Last payment: {{$last_pay->pay_amount ?? ''}}</b><br>
                ...
                <b>Paid By :</b> {{$last_pay->payment_status ?? ''}}
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
              ...
              @csrf
                ...
                <div class="col-md-12">
                  <div class="form-group mb-3">
                      ...
                      <div class="col-sm-12 col-md-12">
                          <input type="text" id="subt" class="form-control" autofocus name="contact_code" readonly>
                      </div>
                  </div>
              </div>
              <div class="col-md-12">
                <div class="form-group mb-3">
                    <label class="col-form-label text-md-left col-12 col-md-12 col-lg-12">Payment Check Number </label>
                    <div class="col-sm-12 col-md-12">
                        <input type="text" class="form-control" autofocus name="check_number">
                    </div>
                </div>
            </div>
            <div class="col-md-12">
              <div class="form-group mb-3">
                  <label class="col-form-label text-md-left col-12 col-md-12 col-lg-12">Check Date/EFT Date  </label>
                  <div class="col-sm-12 col-md-12">
                      <input type="date" class="form-control" autofocus name="check_date">
                  </div>
              </div>
          </div>
              <div class="col-md-12">
              ...
              <div class="col-6">
                ...
                <div class="table-responsive">
                  <table class="table">
                    <tr>
                      <th style="width:50%">Total Sales Amount:</th>
                      @php $gross=0; @endphp
                      @foreach ($order as $data)
                       @php $gross+=$data->total @endphp
