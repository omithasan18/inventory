...
@section('title')
    <title>{{ config('app.name') }} | Manage Distributed</title>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{route('distributed.store')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Distributed Name</label>
                                        <input type="text" name="distributed_name" class="form-control" id="exampleInputEmail1" placeholder="Distributed Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Distributed Location</label>
                                        <input type="text" name="location" class="form-control" id="exampleInputEmail1" placeholder="Distributed Location">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Distributed Phone</label>
                                        <input type="text" name="phone" class="form-control" id="exampleInputEmail1" placeholder="Distributed Phone">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <!-- select -->
