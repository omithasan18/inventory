                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        @foreach($orders as $data)
                                            <tr>
                                                <td>{{$i}}</td>
                                                <td>{{$data->customer->customer_name ?? ''}}({{$data->head_customer->name ?? ''}})</td>
                                                {{-- <td>{{$data->product_code}}</td> --}}
                                                <td>{{$data->pio_number}}</td>
                                                <td>{{$data->pio_date}}</td>
                                            ...
                                            {{-- <td><img src="{{asset($data->image)}}" height="50px" width="50px"></td> --}}
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{route('delete-order',[$data->id])}}" class="btn btn-danger"><i class="fa fa-trash"></i></a>
