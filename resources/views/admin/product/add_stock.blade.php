...
@section('title')
    <title>{{ config('app.name') }} | Add Stock</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{route('update-quantity')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="hidden" value="{{$product_by_id->id}}" class="form-control" autofocus name="product_id">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @foreach($colors as $item)
                                                                <option value="{{$item->id}}" @php if ($data['color_id'] == $item->id) { echo "selected"; } @endphp>{{$item->color_name}}</option>
                                                            @endforeach
                                                         </select>
                                                       </td>
                                                        <td><input type="number" value="0" class="form-control" name="pro_quantity[]" placeholder="Product Quantity"></td>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $(document).on('click', '.add1', function(){
                var html = '';
                html += '<tr>';
                html += '<td><select class="form-control select2" style="width: 100%;" name="color_id[]" data-placeholder="Select Color">@foreach($colors as $item)<option value="{{$item->id ?? ''}}">{{$item->color_name ?? ''}}</option>@endforeach</select></td><td><input type="number" name="pro_quantity[]" class="form-control" placeholder="Product Quantity" required/></td>';
                html += '<td><button type="button" name="remove" class="btn btn-danger btn-sm remove"><span class="fa fa-minus-circle"></span></button></td></tr>';
