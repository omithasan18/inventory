            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{route('product-code.update',$code_by_id->id)}}" method="post">
                            @method('patch')
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="product_id" required>
                                                ...
                                                @foreach ($products as $item)
                                                  <option value="{{$item->id}}" @php if ($code_by_id['product_id'] == $item->id) { echo "selected"; } @endphp>{{$item->title}}({{$item->product_code}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="head_customer_id" required>
                                                ...
                                                <option value="{{$item->id}}" @php if ($code_by_id['head_customer_id'] == $item->id) { echo "selected"; } @endphp>{{$item->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{$code_by_id->customer_product_code ?? ''}}" name="customer_product_code" class="form-control" id="exampleInputEmail1" placeholder="Enter Customer Code">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">GP%</label>
                                    <input type="text" value="{{$code_by_id->gp ?? ''}}" name="gp" class="form-control" id="exampleInputEmail1" placeholder="Enter Product GP">
                                </div>
