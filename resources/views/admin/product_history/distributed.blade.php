...
@section('title')
    <title>{{ config('app.name') }} | Distributed Product History</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-md-6">
                        <h1>Distributed Product History</h1>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Distributed Product History</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                        ...
                        <div class="card card-warning">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="custom-select" id="distributed_id">
                                    ...
                                    @endif
                                    <h3 class="card-title">Manage Distributed Product History</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body" id="get-distributedProduct-history">
    ...
    $(document).ready(function(){
            $('#distributed_id').on('change', function() {
              ...
              $.ajax({
                  type: 'post',
                  dataType: 'html',
                  url: '{{url('admin/get-distributedProduct-history')}}',
                  data: 'distributed_id=' + distributed_id,
                  success:function (response) {
                     console.log(response);
                    $('#get-distributedProduct-history').html(response);
                },
              });
            });
        });
