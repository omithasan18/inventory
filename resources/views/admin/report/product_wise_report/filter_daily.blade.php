                        ...
                        <div class="card card-warning">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Manage Order information</h3><br>
                                    <form action="{{route('filter-daily-sales')}}" method="get">
                                        @csrf
                                        ...
                                        @foreach($products as $data)
                                            <tr>
                                                ...
                                                $balance= DB::table('order_details')
                                                    ...
                                                    ->whereDate('order_details.created_at', Carbon\Carbon::today())->sum('quantity')
                                                @endphp
                                                <td>{{$balance}}</td>
