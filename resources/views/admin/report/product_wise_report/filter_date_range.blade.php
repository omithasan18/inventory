                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-warning">
                            <div class="card">
                                ...
                                <form action="{{route('filter-date-range')}}" method="get" style="margin-left: 1rem; margin-top: 1rem; margin-bottom: 1rem">
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-2">
                                                <label class="col-form-label text-md-left col-12 col-md-12 col-lg-12">Start date<span class="text-danger">*</span></label>
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="date" value="{{request()->input('start_date')}}" name="start_date"/>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="col-form-label text-md-left col-12 col-md-12 col-lg-12">End Date<span class="text-danger">*</span></label>
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="date" value="{{request()->input('end_date')}}" name="end_date"/>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <button type="submit" name="filter" id="filter" class="btn btn-primary" style="margin-top: 37px;">Search</button>
                                            </div>
                                        </div>
                                    </form>
