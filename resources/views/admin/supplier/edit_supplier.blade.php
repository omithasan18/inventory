...
@section('title')
    <title>{{ config('app.name') }} | Edit Supplier</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="{{route('supplier.update',$supplier_by_id->id)}}" method="post" enctype="multipart/form-data">
                                @method('patch')
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="text" value="{{$supplier_by_id->supplier_name}}" class="form-control" autofocus name="supplier_name">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="hidden" name="admin_id" value="">
                                                    <input type="text" value="{{$supplier_by_id->business_name}}" class="form-control" autofocus name="business_name">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="text" value="{{$supplier_by_id->pi_number}}" class="form-control" autofocus name="pi_number">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="text" value="{{$supplier_by_id->contact_code}}" class="form-control" autofocus name="contact_code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="number" value="{{$supplier_by_id->phone}}" class="form-control" autofocus name="phone">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="email" value="{{$supplier_by_id->email}}" class="form-control" autofocus name="email">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="text" value="{{$supplier_by_id->city}}" class="form-control" autofocus name="city">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="text" value="{{$supplier_by_id->state}}" class="form-control" autofocus name="state">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <input type="text" value="{{$supplier_by_id->country}}" class="form-control" autofocus name="country">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                            <img src="{{asset($supplier_by_id->image)}}" alt="" width="50px" height="50px">
                                                ...
                                                <div class="col-sm-12 col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="status">
                                                            <option value="1" @php if ($supplier_by_id['status'] == 1) { echo "selected"; } @endphp>Active</option>
                                                            <option value="0" @php if ($supplier_by_id['status'] == 0) { echo "selected"; } @endphp>Inactive</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
