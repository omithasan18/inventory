...
@section('title')
    <title>{{ config('app.name') }} | Manage wear house</title>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" action="{{route('wear-house.store')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Ware House Name</label>
                                        <input type="text" name="wear_house_name" class="form-control" id="exampleInputEmail1" placeholder="Name">
                                    </div>
                                    <div class="form-group">
